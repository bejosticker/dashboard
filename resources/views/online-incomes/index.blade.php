...
<script>
    ...
    function downloadPDF(el = 'to-print') {
        ...
        html2pdf().set(opt).from(element).save('Pemasukan Toko Online.pdf').then(() => {
            ...
            <tbody class="table-border-bottom-0">
                @forelse ($incomes as $income)
                    <tr>
                        ...
                        <td class="no-print" style="width: 160px;">
                ...
                <tr style="background-color: #d8f3dc; color: white;">
                    ...
                    <td colspan="5"><strong>{{ formatRupiah($incomes->sum('amount')) }}</strong></td>
                </tr>
            </tbody>
        </table>
