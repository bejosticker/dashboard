<div>
    ...
    <div style="margin-bottom: 15px;display: flex; flex-direction: row; align-items: end;" class="row">
        ...
        <div class="col-md-4">
            ...
            <div wire:ignore>
                <select id="cetakCustomerSelect" class="form-control select2-customer"
                    data-modal="createsale" data-proxy="cetakCustomerPhoneProxy" style="width: 100%;">
                    <option value=""></option>
            ...
            <input type="hidden" id="cetakCustomerPhoneProxy" wire:model.live="customer_phone">
