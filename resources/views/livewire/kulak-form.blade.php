<div>
    ...
    @foreach ($items as $i => $item)
        <div style="display: flex; gap: 10px; margin-bottom: 8px; flex-direction: row; align-items: center;" wire:key="item-{{ $i }}">
            ...
            <input type="number" style="width: 140px;" wire:loading.attr="disabled" name="jumlah.{{$i}}" class="form-control" wire:model.debounce.500ms="items.{{ $i }}.jumlah" placeholder="Jumlah" />
